...
contract BuyCreditMarketLendTest is BaseTest {
    ...
    function test_BuyCreditMarket_buyCreditMarket_validation() public {
        _setPrice(1e18);
        _updateConfig("fragmentationFee", 0);
        _updateConfig("overdueLiquidatorReward", 0);
        ...
        _buyCreditMarket(bob, creditPositionId2_1, 500e6, false);
        ...
        _buyCreditMarket(james, creditPositionId1_1, 500e6, false);
    }
}
