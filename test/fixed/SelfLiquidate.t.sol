...
contract SelfLiquidateTest is BaseTest {
    ...
    function test_SelfLiquidate_selfliquidateLoan_creditPosition_insufficient_debt_token_repay_fee_2_concrete()
        public
    {
        _setPrice(1e18);
        _deposit(alice, weth, 200e18);
        ...
        assertEq(size.getUserView(alice).debtBalanceFixed, 5.025002e6);
