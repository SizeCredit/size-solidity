...
import {NonTransferrableRebasingTokenVaultBase} from "@src/market/token/NonTransferrableRebasingTokenVaultBase.sol";
...
abstract contract ExpectedErrors is Deploy, Properties {
    ...
    constructor() {
        ...
        REPAY_ERRORS.push(NonTransferrableRebasingTokenVaultBase.InsufficientTotalAssets.selector);
        ...
        LIQUIDATE_ERRORS.push(NonTransferrableRebasingTokenVaultBase.InsufficientTotalAssets.selector);
