...
interface ISize is ISizeView, ISizeAdmin, IMulticall {
    ...
    ///       - uint256 minTenor: The minimum tenor of the loan offer to copy
    ///       - uint256 maxTenor: The maximum tenor of the loan offer to copy
    ///       - uint256 minAPR: The minimum APR of the loan offer to copy
    ///       - uint256 maxAPR: The maximum APR of the loan offer to copy
    ///     - CopyLimitOrder copyBorrowOffer: The borrow offer to copy (null means no copy)
    ///       - uint256 minTenor: The minimum tenor of the borrow offer to copy
