...
import {Properties} from "@src/invariants/Properties.sol";
...
abstract contract ExpectedErrors is Deploy, Properties {
    ...
    bytes4[] internal SET_MARKET_FOR_SALE_ERRORS;
    ...
    constructor() {
        ...
        // BORROW_AS_MARKET_ORDER_ERRORS
        BORROW_AS_MARKET_ORDER_ERRORS.push(Errors.INVALID_LOAN_OFFER.selector);
        BORROW_AS_MARKET_ORDER_ERRORS.push(Errors.NULL_AMOUNT.selector);
        BORROW_AS_MARKET_ORDER_ERRORS.push(Errors.PAST_DUE_DATE.selector);
        BORROW_AS_MARKET_ORDER_ERRORS.push(Errors.DUE_DATE_GREATER_THAN_MAX_DUE_DATE.selector);
        BORROW_AS_MARKET_ORDER_ERRORS.push(Errors.BORROWER_IS_NOT_LENDER.selector);
        BORROW_AS_MARKET_ORDER_ERRORS.push(Errors.DUE_DATE_LOWER_THAN_DEBT_POSITION_DUE_DATE.selector);
        BORROW_AS_MARKET_ORDER_ERRORS.push(Errors.CR_BELOW_OPENING_LIMIT_BORROW_CR.selector);
        BORROW_AS_MARKET_ORDER_ERRORS.push(Errors.MATURITY_OUT_OF_RANGE.selector);
        BORROW_AS_MARKET_ORDER_ERRORS.push(Errors.NOT_ENOUGH_BORROW_ATOKEN_BALANCE.selector);
        BORROW_AS_MARKET_ORDER_ERRORS.push(Errors.CREDIT_LOWER_THAN_MINIMUM_CREDIT_OPENING.selector);
        BORROW_AS_MARKET_ORDER_ERRORS.push(Errors.CREDIT_LOWER_THAN_MINIMUM_CREDIT.selector);
        BORROW_AS_MARKET_ORDER_ERRORS.push(Errors.NOT_ENOUGH_BORROW_ATOKEN_LIQUIDITY.selector);
        ...
        // BORROWER_EXIT_ERRORS
        BORROWER_EXIT_ERRORS.push(Errors.PAST_DUE_DATE.selector);
        BORROWER_EXIT_ERRORS.push(Errors.MATURITY_BELOW_MINIMUM_MATURITY.selector);
        BORROWER_EXIT_ERRORS.push(Errors.EXITER_IS_NOT_BORROWER.selector);
        BORROWER_EXIT_ERRORS.push(Errors.CR_BELOW_OPENING_LIMIT_BORROW_CR.selector);
        BORROWER_EXIT_ERRORS.push(Errors.MATURITY_OUT_OF_RANGE.selector);
        BORROWER_EXIT_ERRORS.push(Errors.INVALID_BORROW_OFFER.selector);
        BORROWER_EXIT_ERRORS.push(Errors.NOT_ENOUGH_BORROW_ATOKEN_BALANCE.selector);
        BORROWER_EXIT_ERRORS.push(Errors.LOAN_NOT_ACTIVE.selector);
        BORROWER_EXIT_ERRORS.push(Errors.NOT_ENOUGH_BORROW_ATOKEN_LIQUIDITY.selector);

        // REPAY_ERRORS
        REPAY_ERRORS.push(Errors.LOAN_ALREADY_REPAID.selector);
        REPAY_ERRORS.push(Errors.REPAYER_IS_NOT_BORROWER.selector);
