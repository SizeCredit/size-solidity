...
struct Data {
    ...
    // mapping of authorized actions for other accounts per account v1.6.1
    mapping(address onBehalfOf => mapping(address other => mapping(bytes4 action => bool isActionAuthorized)))
        authorizations;
}
