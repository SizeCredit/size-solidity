...
library VariableLibrary {
    ...
    /// @notice Move a fixed-rate FOL to the variable pool by supplying the assigned collateral and paying the liquidator with the move fee
